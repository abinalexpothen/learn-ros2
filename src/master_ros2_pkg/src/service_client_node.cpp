...
public:
    ...
    std::string call_service(const std::string & str1, const std::string & str2)
    {
        ...
        {
            return future_result.get()->concatenated_str;
        }
        else
        {
            RCLCPP_ERROR(this->get_logger(), "Failed to call service concat_strings");
            return "";
        }
    }
...
int main(int argc, char **argv)
{
    ...
    std::string result = node->call_service("Hello, ", "ROS2 is nice!");
